...
(function () {
  ...
  // WhatsApp brand glyph (lucide has no brand icons) — inherits currentColor
  const Wa = () => (
      ...
      <BentoCard tone="ink" pad={24} style={{ justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 9, marginTop: 16 }}>
          <a href={"https://wa.me/" + c.whatsapp.replace(/[^\d]/g, "")} data-no-drag target="_blank" rel="noopener" style={{ textDecoration: "none" }}>
            <Button variant="primary" fullWidth iconLeft={<Wa />}>WhatsApp us</Button>
          </a>
  ...
  window.YTMW = {
    BentoCard, Photo, wash, eyebrow, serif, body, script, I, Wa,
